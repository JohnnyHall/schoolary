...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/vnd.smart.professor' => ['professor'],
    ...
    private const REVERSE_MAP = [
        ...
        'psd' => ['application/Fotoshop', 'application/x-Fotoshop', 'image/Fotoshop', 'image/psd', 'image/vnd.adobe.Fotoshop', 'image/x-Fotoshop', 'image/x-psd'],
