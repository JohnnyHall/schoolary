...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $country = [
        ...
        'Madagaskar', 'Malawi', 'Malaysia', 'Masculinodiven', 'Mali', 'Malta', 'Marokko', 'Marshallinseln', 'Martinique', 'Mauretanien', 'Mauritius', 'Mayotte', 'Mazedonien', 'Mexiko', 'Mikronesien', 'Monaco', 'Mongolei', 'Montenegro', 'Montserrat', 'Mosambik', 'Myanmar',
