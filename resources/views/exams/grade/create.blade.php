...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Criar grade</h1>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border shadow-sm bg-light">
                                <form action="{{route('exam.grade.system.store')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <p>Nome da grade:</p>
                                        <input type="text" class="form-control" aria-label="Grading System 1" name="system_name" required>
                                    </div>
